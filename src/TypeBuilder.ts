...
export abstract class UnionBuilder<TBuilder extends TypeBuilder, TArray, TClass, TMap> {
    ...
    private makeTypeOfKind(kind: TypeKind, forwardingRef: TypeRef | undefined): TypeRef {
        switch (kind) {
            ...
            case "enum":
                return this.makeEnum(this._enumCases, this._enumCaseMap, this._forwardingRef);
            case "class":
                return this.makeClass(this._classes, this._maps, this._forwardingRef);
            case "array":
                return this.makeArray(this._arrays, this._forwardingRef);
            default:
