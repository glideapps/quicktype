...
export declare type TypeSpecVersion = 2 | 3;
export declare type TypeSpecFeatures = {
    version: 2 | 3;
    typeHints: boolean;
    dataClasses: boolean;
};
export declare const typespecOptions: {
    features: EnumOption<TypeSpecFeatures>;
    justTypes: BooleanOption;
    nicePropertyNames: BooleanOption;
};
export declare class TypeSpecTargetLanguage extends TargetLanguage {
...
export declare class TypeSpecRenderer extends ConvenienceRenderer {
    protected readonly pyOptions: OptionValues<typeof typespecOptions>;
    private readonly imports;
    private readonly declaredTypes;
    constructor(targetLanguage: TargetLanguage, renderContext: RenderContext, pyOptions: OptionValues<typeof typespecOptions>);
...
export declare class JSONTypeSpecRenderer extends TypeSpecRenderer {
