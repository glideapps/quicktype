...
- Every PR must enable new fixture coverage in its own diff. Identify the cases and renderer options newly executed there; coverage added only by a future PR does not count.
