...
The argument to `quicktype` is a complex object with many optional properties. [Explore its definition](https://github.com/quicktype/quicktype/blob/master/packages/quicktype-core/src/Run.ts#L126) to understand what options are allowed. For a full mapping of CLI flags to JavaScript properties, please refer to our [Options Mapping Guide](docs/options-mapping.md).
